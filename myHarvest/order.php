					...
					<div class="items">
						...
						<table style="width: 100%">
							<tr>
								...
								<th><label for="ITEM_DESC">ITEM DETAIL</label>								
								<th><label for= "WEIGHT">WT.</label></th>
